(function() {
    ...
    class TableList extends HTMLElement{
        ...
        getButtons(){
            return ` <button type="button" class="sort" data-order="1">Sort 1</button><button type="button" class="sort" data-order="-1">Sort -1</button><button type="button" class="filter">Search</button><input type="text" class="search" hidden/>`        }
